...
class FormModel {
  ...
  final String? addressAttribute_8;
  ...
  FormModel copyWith({
    ...
    return FormModel(
      ...
      addressAttribute_8: addressAttribute_8 ?? this.addressAttribute_8,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'address_attribute_8': addressAttribute_8,
  ...
  factory FormModel.fromMap(Map<String, dynamic> map) {
    return FormModel(
      ...
      addressAttribute_8: map['address_attribute_8'],
  ...
  bool operator ==(Object other) {
    ...
    return other is FormModel &&
        ...
        other.addressAttribute_8 == addressAttribute_8 &&
