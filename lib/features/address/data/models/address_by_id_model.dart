...
class AddressByIdModel {
  ...
  AddressByIdModel copyWith({
    Address? address,
  }) {
    return AddressByIdModel(
  ...
  factory AddressByIdModel.fromMap(Map<String, dynamic> map) {
    return AddressByIdModel(
  ...
  factory AddressByIdModel.fromJson(String source) =>
      AddressByIdModel.fromMap(json.decode(source));

  @override
  String toString() => 'AddressByIdModel(address: $address)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is AddressByIdModel && other.address == address;
  }
